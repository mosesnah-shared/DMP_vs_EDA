...
%% (--) Example 1b: Goal-directed Discrete Movement in Joint-space, EDA
...
gEDA1_EE0 = scatter( a1, x0_EDA1( 1, 2 ), y0_EDA1( 1, 2 ), 2400, 'markerfacecolor', c.blue, 'markeredgecolor', c.black, 'linewidth', 6, 'markerfacealpha', 0.5, 'markeredgealpha', 0.5 );
...
gEDA1_EE = scatter( a1, x_EDA1( 1, 2 ), y_EDA1( 1, 2 ), 2400, 'markerfacecolor', c.blue, 'markeredgecolor', c.black, 'linewidth', 6 );
...
gEDA2_EE0 = scatter( a2, x0_EDA2( 1, 2 ), y0_EDA2( 1, 2 ), 2400, 'markerfacecolor', c.blue, 'markeredgecolor', c.black, 'linewidth', 6 , 'markerfacealpha', 0.5, 'markeredgealpha', 0.5 );
...
gEDA2_EE = scatter( a2, x_EDA2( 1, 2 ), y_EDA2( 1, 2 ), 2400, 'markerfacecolor', c.blue, 'markeredgecolor', c.black, 'linewidth', 6 );
