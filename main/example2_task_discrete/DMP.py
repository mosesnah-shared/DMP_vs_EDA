...
# Flag to check whether we do the fully-streched Configuration of the robot
is_sing   = True 
is_damped = True        # With or Without Damped Least Squares
...
if is_sing:
    ...
    if not is_damped:
        T = 0.85        # The simulation will halt without this definition of duration
...
while data.time <= T:
    ...
    if is_damped:#  If damped least square 
